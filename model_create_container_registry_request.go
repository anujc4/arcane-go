...
// checks if the CreateContainerRegistryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateContainerRegistryRequest{}

// CreateContainerRegistryRequest struct for CreateContainerRegistryRequest
...
type _CreateContainerRegistryRequest CreateContainerRegistryRequest
...
func NewCreateContainerRegistryRequest(description interface{}, enabled interface{}, insecure interface{}, token interface{}, url interface{}, username interface{}) *CreateContainerRegistryRequest {
	this := CreateContainerRegistryRequest{}
...
func (o CreateContainerRegistryRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateContainerRegistryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateContainerRegistryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateContainerRegistryRequest := _CreateContainerRegistryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateContainerRegistryRequest)

	if err != nil {
		return err
	}

	*o = CreateContainerRegistryRequest(varCreateContainerRegistryRequest)

	return err
}

type NullableCreateContainerRegistryRequest struct {
	value *CreateContainerRegistryRequest
	isSet bool
}

func (v NullableCreateContainerRegistryRequest) Get() *CreateContainerRegistryRequest {
	return v.value
}

func (v *NullableCreateContainerRegistryRequest) Set(val *CreateContainerRegistryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateContainerRegistryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateContainerRegistryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateContainerRegistryRequest(val *CreateContainerRegistryRequest) *NullableCreateContainerRegistryRequest {
	return &NullableCreateContainerRegistryRequest{value: val, isSet: true}
}

func (v NullableCreateContainerRegistryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateContainerRegistryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
