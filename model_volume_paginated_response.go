...
// checks if the VolumePaginatedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumePaginatedResponse{}

// VolumePaginatedResponse struct for VolumePaginatedResponse
...
type _VolumePaginatedResponse VolumePaginatedResponse
...
func (o VolumePaginatedResponse) MarshalJSON() ([]byte, error) {
...
func (o VolumePaginatedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VolumePaginatedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumePaginatedResponse := _VolumePaginatedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVolumePaginatedResponse)

	if err != nil {
		return err
	}

	*o = VolumePaginatedResponse(varVolumePaginatedResponse)

	return err
}

type NullableVolumePaginatedResponse struct {
	value *VolumePaginatedResponse
	isSet bool
}

func (v NullableVolumePaginatedResponse) Get() *VolumePaginatedResponse {
	return v.value
}

func (v *NullableVolumePaginatedResponse) Set(val *VolumePaginatedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumePaginatedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumePaginatedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumePaginatedResponse(val *VolumePaginatedResponse) *NullableVolumePaginatedResponse {
	return &NullableVolumePaginatedResponse{value: val, isSet: true}
}

func (v NullableVolumePaginatedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumePaginatedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
